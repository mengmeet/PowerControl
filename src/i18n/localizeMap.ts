...
export enum localizeStrEnum {
  ...
  MANUAL_BYPASS_CHARGE = "MANUAL_BYPASS_CHARGE",
  MANUAL_BYPASS_CHARGE_DESC = "MANUAL_BYPASS_CHARGE_DESC",
  MANUAL_BYPASS_CHARGE_DESC_WITH_LIMIT = "MANUAL_BYPASS_CHARGE_DESC_WITH_LIMIT",
  CHARGE_LIMIT = "CHARGE_LIMIT",
  CHARGE_LIMIT_DESC = "CHARGE_LIMIT_DESC",
  CHARGE_LIMIT_DESC_WITH_BYPASS = "CHARGE_LIMIT_DESC_WITH_BYPASS",
}

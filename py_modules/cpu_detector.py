...
class CPUDetector:
    ...
    def _populate_basic_topology(self):
        ...
        self.topology.vendor, self.topology.family, self.topology.model = self._get_cpu_vendor_info()
    ...
    def _get_cpuid_core_type(self, logical_id: int) -> int:
        ...
        try:
            ...
            cmd = ['taskset', '-c', str(logical_id), 'cpuid', '-r', '-1', '-l', '0x1a', '-s', '0']
        ...
        if self.topology.vendor == "GenuineIntel":
            if self.topology.family == 6 and self.topology.model == 0xAA:  # Meteor Lake
                ...
                try:
                    with open(f'/sys/devices/system/cpu/cpu{logical_id}/cpufreq/cpuinfo_max_freq') as f:
    ...
    def determine_core_type_amd(self, core_info: CPUCoreInfo) -> str:
        ...
        try:
            ...
            with open(f'/sys/devices/system/cpu/cpu{logical_id}/cpufreq/amd_pstate_highest_perf') as f:
            ...
            if core_info.family == 26 and core_info.model == 0x24:
                ...
                return "Zen-Core"  # Default to high-performance, avoid misclassification
